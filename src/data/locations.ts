...
export const LOCATIONS: Location[] = [
  ...
  {
    id: 'skydive-mtcook',
    name: { en: 'Skydive Mount Cook', zh: '库克山跳伞' },
    coords: [-43.9062, 170.1289],
    type: 'activity',
    icon: '🪂',
    description: {
      en: 'Day 5: SKYDIVE! 🪂\n⭐⭐⭐ Rose & Chris only!\n10,000ft tandem jump\nStunning Mt Cook & Lake Pukaki views\nRicky, Yuyu & kids watch from ground',
      zh: '第5天：跳伞！🪂\n⭐⭐⭐ 仅Rose和Chris！\n10,000英尺双人跳伞\n壮观的库克山和普卡基湖景色\nRicky、Yuyu和孩子们在地面观看',
    },
    days: [5],
  },
...
export const DAY_ORDER: Record<number, string[]> = {
  ...
  5: ['tekapo', 'lake-pukaki', 'hooker-valley', 'skydive-mtcook', 'twizel'],
