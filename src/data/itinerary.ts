...
export const ITINERARY: ItineraryDay[] = [
  ...
  },
  {
    ...
    title: { en: 'Skyline + Glenorchy Farewell Day', zh: '天际缆车 + 格林诺奇告别日' },
    subtitle: { en: 'Both families together – last full day as one group', zh: '两家人一起 – 最后一天同行' },
    ...
    sections: [
      ...
      },
      {
        ...
        activities: [
          { time: '7:00 PM', emoji: '🍽️', name: { en: 'FAREWELL DINNER – both families together', zh: '告别晚餐 – 两家人一起' }, type: 'normal', notes: { en: '⭐ Last night both families together! Book a special restaurant in advance. Celebrate an amazing journey!', zh: '⭐ 两家人在一起的最后一晚！提前预订好餐厅。庆祝精彩的旅程！' } },
          { time: '9:00 PM', emoji: '🧳', name: { en: 'Pack for split departures tomorrow', zh: '为明天分开出发打包行李' }, type: 'normal', notes: { en: 'Rose\'s family: pack for Omarama. Chris\'s family: another full day in Glenorchy tomorrow!', zh: 'Rose一家：为奥马拉马打包。Chris一家：明天还有完整的一天在格林诺奇！' } },
        ],
      },
    ],
  },
  {
    ...
    title: { en: 'Families Split – Rose to Omarama / Chris to Paradise', zh: '两家人分开 – Rose前往奥马拉马 / Chris前往天堂谷' },
    base: { en: 'Rose: Omarama (Night 1 of 1) | Chris: Queenstown (Night 3 of 4)', zh: 'Rose：奥马拉马（第1晚，共1晚）| Chris：皇后镇（第3晚，共4晚）' },
    sections: [
      {
        title: { en: "🌸 Rose's Family – Drive to Omarama via Cromwell", zh: '🌸 Rose一家 – 途经克伦威尔驾车前往奥马拉马' },
        activities: [
          { time: '10:00 AM', emoji: '🚗', name: { en: 'Pack up & depart Queenstown (~10 AM)', zh: '打包出发皇后镇（约上午10点）' }, type: 'normal', notes: { en: 'Relaxed start – no early alarm! Head out around 10 AM.', zh: '轻松出发 – 不用早起！约上午10点出发。' } },
          { time: '11:30 AM', emoji: '🍎', name: { en: 'Stop at Cromwell (fruit & heritage town)', zh: '在克伦威尔停留（水果与历史小镇）' }, type: 'optional', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Pick up local stone fruit. Heritage precinct stroll. Grab lunch here.', zh: '购买当地石果。漫步历史区。在这里吃午餐。' } },
          { time: '12:30 PM', emoji: '🏜️', name: { en: 'Scenic drive through Lindis Pass', zh: '穿越Lindis Pass风景驾车' }, type: 'free', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Stunning golden tussock landscapes – great photo stop at the summit!', zh: '壮观的金色草地景观 – 在峰顶绝佳拍照！' } },
          { time: '1:30 PM', emoji: '📍', name: { en: 'Arrive Omarama (~3 hours from Queenstown)', zh: '抵达奥马拉马（距皇后镇约3小时）' }, type: 'normal' },
          { time: '2:00 PM', emoji: '♨️', name: { en: 'OMARAMA HOT TUBS', zh: '奥马拉马温泉浴桶' }, type: 'book-ahead', cost: { en: '~$50/person (private tubs with mountain views)', zh: '约$50/人（私人浴桶，有山景）' }, notes: { en: '⭐ Outdoor cedar hot tubs with stunning MacKenzie Country mountain & sky views! Very relaxing. Book in advance!', zh: '⭐ 露天雪松温泉浴桶，享有壮观的麦肯齐地区山景和天空美景！非常放松。提前预订！' } },
          { time: '4:30 PM', emoji: '🏞️', name: { en: 'Lake Ohau scenic area (optional drive)', zh: '奥豪湖风景区（可选驾车游览）' }, type: 'optional', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Beautiful remote alpine lake, short drive from Omarama. Optional short walk on the shore.', zh: '美丽偏远的高山湖，距奥马拉马短途驾车可达。可在湖边短途步行。' } },
          { time: '6:00 PM', emoji: '🏕️', name: { en: 'Check into Omarama TOP 10 or Lake Ohau Lodge', zh: '入住奥马拉马TOP 10或奥豪湖旅馆' }, type: 'normal', notes: { en: 'Omarama TOP 10 Holiday Park (campervan) or Lake Ohau Lodge for something special', zh: '奥马拉马TOP 10假日公园（房车）或奥豪湖旅馆（特别体验）' } },
          { time: '7:00 PM', emoji: '🍽️', name: { en: 'Dinner at accommodation or local café', zh: '在住宿处或当地咖啡馆晚餐' }, type: 'normal', notes: { en: 'Omarama is small – cook at camp or eat at local café. Early night under dark skies!', zh: '奥马拉马很小 – 在营地做饭或去当地咖啡馆。在暗夜星空下早点休息！' } },
        ],
      },
      {
        title: { en: "🏔️ Chris's Family – Full Day Glenorchy & Paradise (No Rush!)", zh: '🏔️ Chris一家 – 全天格林诺奇 & 天堂谷（不用赶！）' },
        activities: [
          { time: '9:00 AM', emoji: '🍳', name: { en: 'Relaxed breakfast – full day ahead!', zh: '悠闲早餐 – 整天都是你的！' }, type: 'normal' },
          { time: '10:00 AM', emoji: '🚗', name: { en: 'Scenic drive to Glenorchy', zh: '风景驾车前往格林诺奇' }, type: 'free', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Stop at Bennett\'s Bluff, Bob\'s Cove – take your time for photos!', zh: '在Bennett\'s Bluff、Bob\'s Cove停留 – 慢慢来拍照！' } },
          { time: '11:00 AM', emoji: '🚶', name: { en: 'Glenorchy Walkway & Village', zh: '格林诺奇步道 & 小镇' }, type: 'free', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Easy lagoon walk, kid-friendly. Explore the village properly.', zh: '轻松泻湖步道，适合儿童。好好探索小镇。' } },
          { time: '12:00 PM', emoji: '🍽️', name: { en: 'Lunch at Glenorchy Trading Post', zh: '在格林诺奇贸易所午餐' }, type: 'normal' },
          { time: '1:00 PM', emoji: '🌲', name: { en: 'Drive to Paradise (Lord of the Rings!)', zh: '驾车前往天堂谷（《指环王》拍摄地！）' }, type: 'free', cost: { en: 'FREE', zh: '免费' }, notes: { en: '⭐ 25 min gravel road. Stunning beech forest. LOTR filming locations! No time pressure – explore freely.', zh: '⭐ 25分钟砾石路。壮观山毛榉森林。指环王拍摄地！不用赶时间 – 自由探索。' } },
          { time: '4:00 PM', emoji: '🚗', name: { en: 'Return to Queenstown', zh: '返回皇后镇' }, type: 'normal' },
          { time: '6:00 PM', emoji: '🍽️', name: { en: 'Dinner in Queenstown – last night!', zh: '皇后镇晚餐 – 最后一晚！' }, type: 'normal', notes: { en: 'Relax and enjoy. Pack up tonight – driving to Christchurch tomorrow.', zh: '放松享受。今晚打包行李 – 明天驾车前往基督城。' } },
          { time: '9:00 PM', emoji: '🧳', name: { en: 'Pack up – drive to Christchurch tomorrow (~10 AM)', zh: '打包行李 – 明天驾车前往基督城（约上午10点）' }, type: 'normal', notes: { en: '5-5.5 hour drive tomorrow. Leave ~10 AM, arrive Christchurch late afternoon.', zh: '明天驾车5-5.5小时。约10点出发，傍晚抵达基督城。' } },
        ],
      },
    ],
  },
  {
    ...
    title: { en: "Rose Departs NZ / Chris Drives to Christchurch", zh: 'Rose离开新西兰 / Chris驾车前往基督城' },
    base: { en: 'Rose: Departs NZ ✈️ | Chris: Christchurch (Night 1 of 1)', zh: 'Rose：离开新西兰 ✈️ | Chris：基督城（第1晚，共1晚）' },
    sections: [
      {
        title: { en: "🌸 Rose's Family – Relaxed Morning Drive & Departure", zh: '🌸 Rose一家 – 轻松早晨驾车 & 出发' },
        activities: [
          ...
          { time: '9:30 AM', emoji: '🚗', name: { en: 'Depart Omarama → Christchurch', zh: '出发奥马拉马 → 基督城' }, type: 'normal', notes: { en: '~2.5 hour drive via Burke Pass through beautiful MacKenzie Country', zh: '途经Burke Pass穿越美丽的麦肯齐地区约2.5小时' } },
          { time: '12:00 PM', emoji: '📍', name: { en: 'Arrive Christchurch (~12 PM)', zh: '抵达基督城（约中午12点）' }, type: 'normal' },
          { time: '12:30 PM', emoji: '🌿', name: { en: 'Light exploration or relax', zh: '轻松探索或休息' }, type: 'optional', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Christchurch Botanic Gardens (free & beautiful!) or a chill café lunch', zh: '基督城植物园（免费且美丽！）或悠闲咖啡馆午餐' } },
          { time: '3:30 PM', emoji: '🚐', name: { en: 'Return campervan to JUCY depot', zh: '在JUCY站点归还房车' }, type: 'normal', notes: { en: 'Allow time for final inspection and paperwork. Christchurch Airport.', zh: '留时间进行最终检查和文件。基督城机场。' } },
      ...
      {
        title: { en: "🏔️ Chris's Family – Scenic Drive to Christchurch", zh: '🏔️ Chris一家 – 风景驾车前往基督城' },
        activities: [
          { time: '9:00 AM', emoji: '🍳', name: { en: 'Breakfast & check out of Queenstown', zh: '皇后镇早餐 & 退房' }, type: 'normal' },
          { time: '10:00 AM', emoji: '🚗', name: { en: 'Depart Queenstown → Christchurch', zh: '出发皇后镇 → 基督城' }, type: 'normal', notes: { en: '~5-5.5 hour drive via Cromwell, Lindis Pass, Omarama, Burke Pass, Geraldine', zh: '途经克伦威尔、Lindis Pass、奥马拉马、Burke Pass、Geraldine约5-5.5小时' } },
          { time: '11:30 AM', emoji: '☕', name: { en: 'Stop at Cromwell or Lindis Pass viewpoint', zh: '在克伦威尔或Lindis Pass观景台停留' }, type: 'optional', cost: { en: 'FREE', zh: '免费' }, notes: { en: 'Grab lunch at Cromwell, or stretch legs at Lindis Pass summit', zh: '在克伦威尔午餐，或在Lindis Pass峰顶舒展身体' } },
          { time: '3:30 PM', emoji: '📍', name: { en: 'Arrive Christchurch (late afternoon)', zh: '抵达基督城（傍晚）' }, type: 'normal' },
          { time: '4:00 PM', emoji: '🏕️', name: { en: 'Check into Christchurch TOP 10 Holiday Park', zh: '入住基督城TOP 10假日公园' }, type: 'normal', notes: { en: 'Near the airport – perfect for tomorrow\'s departure', zh: '靠近机场 – 非常方便明天出发' } },
          { time: '6:00 PM', emoji: '🍽️', name: { en: 'Dinner near the holiday park', zh: '假日公园附近晚餐' }, type: 'normal' },
  ...
  },
  {
    ...
    sections: [
      {
        title: { en: '🍄 Morning – Bottle Lake Forest Park', zh: '🍄 上午 – 瓶湖森林公园' },
        activities: [
          { time: '8:30 AM', emoji: '🍳', name: { en: 'Early breakfast at Christchurch holiday park', zh: '基督城假日公园早餐' }, type: 'normal' },
          { time: '9:00 AM', emoji: '🍄', name: { en: 'BOTTLE LAKE FOREST PARK – Mushroom Foraging', zh: '瓶湖森林公园 – 采蘑菇' }, type: 'free', cost: { en: 'FREE entry', zh: '免费入园' }, notes: { en: '⭐ Pine mushrooms & saffron milk caps! 2-3 hours foraging in pine plantation. Just 20 min from airport. Kids absolutely LOVE hunting for mushrooms!', zh: '⭐ 松茸和藏红花乳菇！在松树林中采摘2-3小时。距机场仅20分钟。孩子们超喜欢寻找蘑菇！' } },
          { time: '12:00 PM', emoji: '🚗', name: { en: 'Return to holiday park / head to airport area', zh: '返回假日公园 / 前往机场区域' }, type: 'normal' },
        ],
      },
      {
        title: { en: 'Afternoon – Campervan Return & Departure', zh: '下午 – 归还房车 & 出发' },
        activities: [
          { time: '1:00 PM', emoji: '🚐', name: { en: 'Return campervan to JUCY depot', zh: '在JUCY站点归还房车' }, type: 'normal', notes: { en: 'Final inspection. 10-day NZ campervan adventure complete! 🎉', zh: '最终检查。10天新西兰房车探险圆满结束！🎉' } },
          { time: '2:00 PM', emoji: '✈️', name: { en: 'Relax at airport', zh: '在机场休息' }, type: 'normal', notes: { en: 'Grab food, browse duty free, enjoy reliving the amazing memories!', zh: '吃点东西，逛免税店，回味精彩的旅行记忆！' } },
    ...
    notes: { en: 'Safe travels home! What an incredible 10-day NZ adventure! 🇳🇿 Bottle Lake Forest Park is a magical final morning – pine mushrooms make a great souvenir!', zh: '一路平安！令人难忘的10天新西兰探险！🇳🇿 瓶湖森林公园是美好的最后早晨 – 松茸是极好的纪念品！' },
  },
];
