...
export const ITINERARY: ItineraryDay[] = [
  ...
  },
  {
    ...
    title: { en: 'Mt Cook Day Trip → Drive to Twizel', zh: '库克山一日游 → 驱车前往特威泽尔' },
    subtitle: { en: 'Hooker Valley Track + Lake Pukaki, then overnight at Twizel', zh: 'Hooker Valley步道 + 普卡基湖，然后在特威泽尔过夜' },
    ...
    sections: [
      ...
      },
      {
        ...
        activities: [
          ...
          { time: '1:30 PM', emoji: '🍽️', name: { en: 'Picnic lunch', zh: '野餐午餐' }, type: 'normal' },
        ],
      },
      {
        title: { en: 'Afternoon – Drive to Twizel', zh: '下午 – 驱车前往特威泽尔' },
        activities: [
          { time: '3:00 PM', emoji: '🏨', name: { en: 'Mt Cook Village quick explore', zh: '库克山村快速探索' }, type: 'free' },
          { time: '4:00 PM', emoji: '🚗', name: { en: 'Drive to Twizel', zh: '驱车前往特威泽尔' }, type: 'normal', notes: { en: '~45 min drive. Saves driving time for Queenstown tomorrow!', zh: '约45分钟车程。为明天去皇后镇节省时间！' } },
          { time: '4:45 PM', emoji: '🏕️', name: { en: 'Check into Twizel Holiday Park', zh: '入住特威泽尔假日公园' }, type: 'normal' },
        ],
      },
      {
        title: { en: 'Evening', zh: '晚上' },
        activities: [
          { time: '6:00 PM', emoji: '🍽️', name: { en: 'Dinner in Twizel', zh: '在特威泽尔晚餐' }, type: 'normal' },
          { time: '9:00 PM', emoji: '🧳', name: { en: 'Pack for Queenstown', zh: '为皇后镇打包' }, type: 'normal' },
        ],
      },
    ],
    notes: { en: 'Hooker Valley is THE highlight! Twizel overnight saves driving time for tomorrow\'s Queenstown drive.', zh: 'Hooker Valley是旅行亮点！在特威泽尔过夜为明天去皇后镇节省驾驶时间。' },
  },
  {
    day: 6,
    date: 'April 16, 2026',
  ...
  },
  {
    ...
    title: { en: 'Both Families → Omarama', zh: '两家人一起 → 奥马拉马' },
    subtitle: { en: 'Hot tubs & dark skies overnight', zh: '温泉浴桶 & 暗夜星空过夜' },
    base: { en: 'Both Families: Omarama (1 night)', zh: '两家人：奥马拉马（1晚）' },
    sections: [
      {
        title: { en: 'Morning – Depart Queenstown', zh: '上午 – 离开皇后镇' },
        activities: [
          { time: '8:30 AM', emoji: '🍳', name: { en: 'Breakfast', zh: '早餐' }, type: 'normal' },
          { time: '10:00 AM', emoji: '🚗', name: { en: 'BOTH FAMILIES depart for Omarama', zh: '两家人一起出发前往奥马拉马' }, type: 'normal', notes: { en: '~3 hour drive via Cromwell & Lindis Pass', zh: '途经克伦威尔和Lindis Pass约3小时' } },
          { time: '1:00 PM', emoji: '📍', name: { en: 'Arrive Omarama', zh: '抵达奥马拉马' }, type: 'normal' },
        ],
      },
      {
        title: { en: 'Afternoon – Hot Tubs!', zh: '下午 – 温泉浴桶！' },
        activities: [
          { time: '2:00 PM', emoji: '♨️', name: { en: 'OMARAMA HOT TUBS', zh: '奥马拉马温泉浴桶' }, type: 'book-ahead', cost: { en: '~$50/person', zh: '约$50/人' }, notes: { en: '⭐ Outdoor cedar hot tubs with mountain views!', zh: '⭐ 露天雪松温泉浴桶，有山景！' } },
          { time: '4:30 PM', emoji: '🏞️', name: { en: 'Lake Ohau (optional)', zh: '奥豪湖（可选）' }, type: 'optional', cost: { en: 'FREE', zh: '免费' } },
      ...
      },
      {
        ...
        activities: [
          { time: '7:00 PM', emoji: '🍽️', name: { en: 'Dinner together', zh: '一起晚餐' }, type: 'normal' },
          { time: '9:00 PM', emoji: '⭐', name: { en: 'Stargazing – dark skies!', zh: '观星 – 暗夜星空！' }, type: 'free', cost: { en: 'FREE', zh: '免费' } },
        ],
      },
    ],
  },
